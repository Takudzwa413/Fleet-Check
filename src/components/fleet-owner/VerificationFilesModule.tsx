        ...
        <div className="space-y-3">
          {uploadedDocs.length === 0 ? (
            ...
            uploadedDocs.map(doc => (
              <div key={doc.id} className="p-3.5 border border-slate-200 rounded-xl text-xs flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 bg-white shadow-2xs hover:border-slate-300 transition-all">
                <div className="space-y-1">
                  <div className="font-bold text-slate-900 capitalize flex flex-wrap items-center gap-2">
