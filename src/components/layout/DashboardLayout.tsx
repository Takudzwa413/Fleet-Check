...
export default function DashboardLayout({
  ...
  return (
    <div className="w-full bg-[#f4f4f4] text-[#1f1f1f] rounded-2xl sm:rounded-3xl border border-stone-200/80 shadow-2xs overflow-hidden flex flex-col min-h-[92vh]">
      ...
      <div className="flex flex-1 relative overflow-hidden">
        ...
        <aside className={`
          ...
          fixed lg:static inset-y-0 left-0 z-50 lg:z-40 w-72 bg-[#ffffff] border-r border-stone-200/80
          p-5 sm:p-6 flex flex-col justify-between transition-transform duration-200 ease-out shrink-0 overflow-y-auto max-h-screen lg:max-h-none shadow-xl lg:shadow-none
        `}>
          <div className="space-y-6">
            {/* Top Brand & Mobile Close in Sidebar */}
            <div className="flex items-center justify-between pb-3 border-b border-stone-100 lg:border-none">
              ...
              <div className="flex items-center gap-1.5">
                ...
                <button
                  ...
                  className="lg:hidden p-2 rounded-xl text-stone-500 hover:text-stone-900 hover:bg-stone-100 cursor-pointer"
        ...
        <div className="flex-1 flex flex-col min-w-0 bg-[#f4f4f4] overflow-y-auto">
          ...
          {/* TOP CONTROL BAR */}
          <header className="px-3.5 sm:px-8 py-3 bg-[#f6f7ed] border-b border-stone-200/80 sticky top-0 z-20 flex items-center justify-between gap-2.5">
            {/* Mobile Drawer Trigger */}
            <button
              onClick={() => setMobileMenuOpen(true)}
              className="lg:hidden flex items-center gap-1.5 px-3 py-2 rounded-xl bg-white border border-stone-200 text-stone-800 font-bold text-xs shadow-2xs hover:bg-stone-50 cursor-pointer shrink-0 min-h-[40px]"
              aria-label="Open Navigation Menu"
            >
              <Menu className="h-4 w-4 text-stone-900" />
              <span className="text-xs font-bold">Tabs</span>
            </button>
            ...
            <div className="relative flex-1 min-w-0 max-w-lg">
              ...
              <input
                ...
                className="w-full pl-9 pr-8 py-2 bg-white/90 border border-stone-200/80 rounded-xl text-xs sm:text-sm text-[#1f1f1f] placeholder-stone-400 outline-none focus:bg-white focus:ring-2 focus:ring-stone-300 transition-all min-h-[40px]"
              />
              {searchQuery && (
                <button
                  onClick={() => {
            ...
            <div className="flex items-center space-x-2 shrink-0">
              ...
              <div className="relative">
                <button
                  ...
                  className="p-2 rounded-xl bg-white lg:bg-transparent border lg:border-none border-stone-200 text-[#1f1f1f] hover:bg-stone-200/50 cursor-pointer relative transition-colors min-h-[40px] min-w-[40px] flex items-center justify-center shadow-2xs lg:shadow-none"
                  aria-label="Notifications"
                >
                  <Bell className="h-4 w-4" />
                  {unreadNotifications.length > 0 && (
                    <span className="absolute top-2 right-2 h-1.5 w-1.5 rounded-full bg-rose-600"></span>
                  )}
                </button>
            ...
            <div className="bg-white rounded-3xl p-5 sm:p-6 lg:p-7 border border-stone-200/80 shadow-2xs">
              <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-5">
                ...
                {(heroActionLabel || heroSecondaryActionLabel) && (
                  <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2.5 w-full lg:w-auto pt-2 lg:pt-0">
                    {heroSecondaryActionLabel && (
                      <button
                        onClick={onHeroSecondaryAction}
                        className="w-full sm:w-auto px-4 py-2.5 rounded-xl text-xs font-bold border border-stone-200 bg-white text-stone-700 hover:bg-stone-50 transition-colors cursor-pointer text-center justify-center min-h-[44px] flex items-center shadow-2xs"
                      >
                        {heroSecondaryActionLabel}
                      </button>
                    )}
                    {heroActionLabel && (
                      <button
                        ...
                        className="w-full sm:w-auto flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl text-xs font-bold bg-[#1f1f1f] text-white hover:bg-stone-800 transition-colors cursor-pointer shadow-2xs min-h-[44px]"
                      >
                        {heroActionIcon}
