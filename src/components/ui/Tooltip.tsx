      ...
      <AnimatePresence>
        {isVisible && (
          <motion.div
            ...
            className={`absolute z-50 ${getPositionClasses()} ${maxWidth} max-w-[calc(100vw-2rem)] w-max pointer-events-${interactive ? 'auto' : 'none'}`}
            style={{ minWidth: '140px' }}
          >
            <div className="bg-[#1f1f1f] text-stone-100 text-xs rounded-xl px-3.5 py-2.5 shadow-xl border border-stone-800 space-y-1 text-left leading-relaxed break-words">
              {title && (
