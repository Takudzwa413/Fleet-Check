...
export default function UploadPOPModal({
  ...
  const [paymentType, setPaymentType] = useState<'weekly_contribution' | 'deposit' | 'penalty' | 'insurance_premium'>('weekly_contribution');
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const res = await fetch(`/api/stokvel/projects/${project.id}/payments/upload-pop`, {
        method: 'POST',
        headers: {
        ...
        body: JSON.stringify({
          ...
          file_data: compressedDataUrl || undefined,
