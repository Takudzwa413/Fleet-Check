...
export interface Project {
  ...
  notes: string;
  constitution_document_name?: string | null;
  constitution_document_data?: string | null;
...
export interface ProjectMemberSlot {
  ...
  grace_period_end_date: string | null; // post-benefit-handover grace period
  first_arrears_date: string | null; // when outstanding balance first exceeded default_threshold (this episode)
  default_grace_period_end_date: string | null; // deadline to clear arrears before escalation to dismissal_review
...
export interface ProjectPaymentAllocation {
  ...
  target_id?: string | null; // obligation id or penalty id
...
export interface ProjectInsuranceRecord {
  id: string;
  project_id: string;
  vehicle_benefit_id?: string | null;
  slot_id?: string | null;
  user_id: string;
  user_name?: string;
  vehicle_reg: string;
